google.maps.__gjsload__('map', function(_) {
    var jma = function(a) {
        ...
        Xma = function(a, b, c) {
            ...
            else b = "roadmap" == b && 1 < _.Ok() && c.mz ? new hx(Rma(a),
        ...
        gna = function(a) {
            return new _.br([a.draggable, a.Wy, a.An], _.Nl(fna, ena))
        },
        ...
        ux = function(a, b, c) {
            function d() {
                ...
                var r = ux.Iz(a.getDiv());
                r.width -= e;
                r.width = Math.max(1, r.width);
                r.height -= f;
                r.height = Math.max(1, r.height);
                q = a.getProjection();
                var t = ux.Jz(q, b, r, a.get("isFractionalZoomEnabled")),
                    u = ux.cA(b, q);
                if (_.Vd(t) && u) {
    ...
    wx.prototype.tq = function(a) {
        return this.h(this.g.tq(a))
    };
    ...
    Vx.prototype.jg = function(a) {
        if (this.active) {
            ...
            this.active.lf.gj({
                center: b.center,
                zoom: this.active.qC + (a.ab.clientY - this.active.origin.clientY) / 128,
                heading: b.heading,
                tilt: b.tilt
            })
        }
        ...
        if (l) {
            ...
            h.F.then(function(ia) {
                a.get("webgl") && _.ej[15] || sma(ia) ? (_.Q(a,
                    ...
                    try {
                        var Mc = Ea.Ny(m.ud, Ta, Na, aa.g, ia, _.rd(_.sd), kb, _.bs(Yc, !0), dx(_.I(Yc.g.m, 2, _.vm)), a, z)
                    } catch (Hd) {
                        gb = !0
                    } finally {
                        gb ? h.V(!1) : (h.V(!0), h.qb = Mc, Na.fr(Mc.kx()))
                    }
                })) : h.V(!1)
            });
            ...
            _.w.Promise.all([h.C, h.F]).then(function(ia) {
                ...
                if (Ea || ia) Ob.Eb.kD = new $x(Na, Ob, Ea, ia, jd)
            });
            ...
            a.g || (la = function() {
                ...
                _.w.Promise.all([_.Se("controls"), h.C, h.F]).then(function(ia) {
                    ...
                    var Hd = gb && (tma(kb) || !1);
                    kb = gb && (uma(kb) || !1);
                    ia.tB(Mc, a, aa, Ea, x, t.report_map_issue, Pb, Rb, m.Tg, c, h.wd, u, bg, Na, gb, Hd, kb);
                    ia.uB(a, m.ud, Ea, Hd, kb);
                    ia.mr(c)
                })
