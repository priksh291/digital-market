/*! tsParticles v1.18.11 by Matteo Bruni */ ! function(t, i) {
    ...
    return (() => {
        ...
        var t = {
                714: (t, i, e) => {
                    ...
                    var l, c, d, h, u, v, p, y, f, m, g, b, w, x, k = function(t, i, e, o) {
                    ...
                    class P {
                        ...
                        static get animate() {
                            return P.isSsr() ? t => setTimeout(t) : t => (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || window.setTimeout)(t)
                        }
                        static get cancelAnimation() {
                            return P.isSsr() ? t => clearTimeout(t) : t => (window.cancelAnimationFrame || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || window.clearTimeout)(t)
                        }
                        ...
                        static itemFromArray(t, i, e = !0) {
                            return t[void 0 !== i && e ? i % t.length : P.arrayRandomIndex(t)]
                        }
                        static isPointInside(t, i, e, o) {
                            return P.areBoundsInside(P.calculateBounds(t, null != e ? e : 0), i, o)
                        }
                            ...
                            for (const e of i) {
                                ...
                                for (const i in e) {
                                    ...
                                    const o = e[i],
                                        s = "object" == typeof o,
                                        n = t;
                                    n[i] = s && Array.isArray(o) ? o.map((t => P.deepExtend(n[i], t))) : P.deepExtend(n[i], o)
                                }
                            }
                            return t
                        }
                        static isDivModeEnabled(t, i) {
                            return i instanceof Array ? !!i.find((i => i.enable && P.isInArray(t, i.mode))) : P.isInArray(t, i.mode)
                        }
                        ...
                        static divMode(t, i) {
                            if (i && t) return t instanceof Array ? t.find((t => M(i, t.selectors))) : M(i, t.selectors) ? t : void 0
                        }
                    ...
                    class E {
                        ...
                        static drawShapeAfterEffect(t, i, e, o, s, n) {
                            if (!e.shape) return;
                            const a = t.drawers.get(e.shape);
                            (null == a ? void 0 : a.afterEffect) && a.afterEffect(i, e, o, s, n.value, t.retina.pixelRatio)
                        }
                    ...
                    function(t) {
                        t.bounce = "bounce", t.bounceHorizontal = "bounce-horizontal", t.bounceVertical = "bounce-vertical", t.none = "none", t.out = "out", t.destroy = "destroy"
                    }(u || (u = {})),
                    function(t) {
                    ...
                    class B {
                        ...
                        static getAvailablePlugins(t) {
                            const i = new Map;
                            for (const e of V) e.needsPlugin(t.options) && i.set(e.id, e.getPlugin(t));
                            return i
                        }
                    ...
                    class W {
                        ...
                        subdivide() {
                            const t = this.rectangle.position.x,
                                ...
                                s = this.capacity;
                            this.northEast = new W(new I(t, i, e / 2, o / 2), s), this.northWest = new W(new I(t + e / 2, i, e / 2, o / 2), s), this.southEast = new W(new I(t, i + o / 2, e / 2, o / 2), s), this.southWest = new W(new I(t + e / 2, i + o / 2, e / 2, o / 2), s), this.divided = !0
                        }
                        insert(t) {
                            var i, e, o, s, n;
                        ...
                        queryCircleWarp(t, i, e) {
                            const o = e,
                                s = e;
                            return this.query(new L(t.x, t.y, i, void 0 !== o.canvas ? o.canvas.size : s))
                        }
                        queryRectangle(t, i) {
                    ...
                    class G {
                        ...
                        init(t) {
                            ...
                            return U(this, void 0, void 0, (function*() {
                                const e = t.options;
                                if (P.isInArray(g.char, e.particles.shape.type) || P.isInArray(g.character, e.particles.shape.type)) {
                        ...
                        draw(t, i, e) {
                            ...
                            if (void 0 === s) return;
                            const n = i;
                            void 0 === n.text && (n.text = s instanceof Array ? P.itemFromArray(s, i.randomIndexData) : s);
                            const a = n.text,
                                r = o.style,
                                l = o.weight,
                                c = 2 * Math.round(e),
                    ...
                    class j {
                        ...
                        init(t) {
                            ...
                            return $(this, void 0, void 0, (function*() {
                                ...
                                if (!P.isInArray(g.image, e.type) && !P.isInArray(g.images, e.type)) return;
                        ...
                        loadImageShape(t, i) {
                            return $(this, void 0, void 0, (function*() {
                                try {
                                    const e = i.replaceColor ? yield P.downloadSvgImage(i.src): yield P.loadImage(i.src);
                                    this.addImage(t, e)
                                } catch (t) {
                    ...
                    class tt {
                        ...
                        drawParticle(t, i) {
                            ...
                            const l = this.container.options,
                                ...
                                g = A.colorToRgb(m),
                                b = u && void 0 !== h ? h : null != g ? g : a ? A.hslToRgb(a) : void 0,
                                w = u && void 0 !== h ? h : null != g ? g : r ? A.hslToRgb(r) : void 0,
                                ...
                                for (const n of s) {
                                    ...
                                    if (o.links.triangles.enable) {
                                        const r = s.map((t => t.destination)),
                                            l = a.links.filter((t => i.particles.getLinkFrequency(a, t.destination) <= a.particlesOptions.links.frequency && r.indexOf(t.destination) >= 0));
                                        if (l.length)
                                            for (const i of l) {
                    ...
                    class et {
                        ...
                        updateOutMode(t, i, e) {
                            ...
                            switch (i) {
                                ...
                                case "bounceHorizontal":
                                    ...
                                    break;
                                case u.destroy:
                                    P.isPointInside(s.position, o.canvas.size, s.getRadius(), e) || o.particles.remove(s);
                                    break;
                                case u.out:
                                    P.isPointInside(s.position, o.canvas.size, s.getRadius(), e) || this.fixOutOfCanvasPosition(e);
                                    break;
                                case u.none:
                                    this.bounceNone(e)
                            }
                        ...
                        bounceNone(t) {
                            ...
                            } else P.isPointInside(i.position, o.canvas.size, i.getRadius(), t) || o.particles.remove(i)
                        }
                    }
                    class ot {
                        constructor() {
                    ...
                    class bt {
                        constructor() {
                            this.destroy = f.none, this.enable = !1, this.minimumValue = 0, this.speed = 2, this.startValue = b.random, this.sync = !1
                        }
                        get opacity_min() {
                    ...
                    class xt {
                        ...
                        load(t) {
                            ...
                            if (void 0 !== s)
                                for (const t in s) {
                                    const i = s[t];
                                    void 0 !== i && (this.options[t] = P.deepExtend(null !== (e = this.options[t]) && void 0 !== e ? e : {}, i))
                                }
                        ...
                        loadShape(t, i, e, o) {
                            var s, n, a, r;
                            void 0 !== t && (t instanceof Array ? (this.options[i] instanceof Array || (this.options[i] = [], this.options[e] && !o || (this.options[e] = [])), this.options[i] = P.deepExtend(null !== (s = this.options[i]) && void 0 !== s ? s : [], t), this.options[e] && !o || (this.options[e] = P.deepExtend(null !== (n = this.options[e]) && void 0 !== n ? n : [], t))) : (this.options[i] instanceof Array && (this.options[i] = {}, this.options[e] && !o || (this.options[e] = {})), this.options[i] = P.deepExtend(null !== (a = this.options[i]) && void 0 !== a ? a : {}, t), this.options[e] && !o || (this.options[e] = P.deepExtend(null !== (r = this.options[e]) && void 0 !== r ? r : {}, t))))
                        }
                    }
                    class kt {
                        constructor() {
                            this.destroy = f.none, this.enable = !1, this.minimumValue = 0, this.speed = 5, this.startValue = b.random, this.sync = !1
                        }
                        get size_min() {
                            return this.minimumValue
                        }
                    ...
                    class Pt extends dt {
                        constructor() {
                            super(), this.animation = new Mt, this.direction = a.clockwise, this.path = !1
                        }
                        load(t) {
                    ...
                    class Ft {
                        constructor() {
                            this.count = 0, this.delay = new Lt, this.duration = new Ht
                        }
                        load(t) {
                    ...
                    class Vt {
                        constructor() {
                            this.bounce = new Et, this.collisions = new Ot, this.color = new Ct, this.life = new Ft, this.links = new at, this.move = new ft, this.number = new gt, this.opacity = new wt, this.reduceDuplicates = !1, this.rotate = new Pt, this.shadow = new St, this.shape = new xt, this.size = new zt, this.stroke = new At, this.twinkle = new It
                        }
                        get line_linked() {
                            return this.links
                        }
                    ...
                    class _t {
                        ...
                        moveParallax() {
                            const t = this.container,
                                i = t.options;
                            if (P.isSsr() || !i.interactivity.events.onHover.parallax.enable) return;
                            const e = this.particle,
                        ...
                        getProximitySpeedFactor() {
                            const t = this.container,
                                i = t.options;
                            if (!P.isInArray(d.slow, i.interactivity.events.onHover.mode)) return 1;
                    ...
                    class Bt {
                        constructor(t, i, e, o) {
                            ...
                            if (this.shape = w instanceof Array ? P.itemFromArray(w, this.id, x) : w, null == o ? void 0 : o.shape) {
                                if (o.shape.type) {
                                    const t = o.shape.type;
                                    this.shape = t instanceof Array ? P.itemFromArray(t, this.id, x) : t
                                }
                                const t = new xt;
                                if (t.load(o.shape), this.shape) {
                                    const i = t.options[this.shape];
                                    i && (this.shapeData = P.deepExtend({}, i instanceof Array ? P.itemFromArray(i, this.id, x) : i))
                                }
                            } else {
                                const t = g.shape.options[this.shape];
                                t && (this.shapeData = P.deepExtend({}, t instanceof Array ? P.itemFromArray(t, this.id, x) : t))
                            }
                            ...
                            if (E.enable) {
                                if (this.size.status = y.increasing, !S) switch (E.startValue) {
                                    case b.min:
                                        ...
                                        break;
                                    case b.random:
                                        this.size.value = r.randomInRange(E.minimumValue * f, this.size.value);
                                        break;
                                    case b.max:
                                    default:
                            ...
                            const L = D.animation;
                            if (L.enable) {
                                if (this.opacity.status = y.increasing, !I) switch (L.startValue) {
                                    case b.min:
                                        this.opacity.value = L.minimumValue;
                                        break;
                                    case b.random:
                                        this.opacity.value = r.randomInRange(L.minimumValue, this.opacity.value);
                                        break;
                                    case b.max:
                                    default:
                                        this.opacity.status = y.decreasing
                                }
                                this.opacity.velocity = L.speed / 100 * i.retina.reduceFactor, L.sync || (this.opacity.velocity *= Math.random())
                            }
                            this.sides = 24;
                            let H = i.drawers.get(this.shape);
                            H || (H = B.getShapeDrawer(this.shape), H && i.drawers.set(this.shape, H));
                            const F = null == H ? void 0 : H.getSidesCount;
                            F && (this.sides = F(this));
                            const V = this.loadImageShape(i, H);
                            if (V && (this.image = V.image, this.fill = V.fill, this.close = V.close), this.stroke = this.particlesOptions.stroke instanceof Array ? P.itemFromArray(this.particlesOptions.stroke, this.id, x) : this.particlesOptions.stroke, this.strokeWidth = this.stroke.width * i.retina.pixelRatio, this.strokeColor = {
                            ...
                            const q = g.life;
                            this.lifeDelay = i.retina.reduceFactor ? r.getValue(q.delay) * (q.delay.sync ? 1 : Math.random()) / i.retina.reduceFactor * 1e3 : 0, this.lifeDelayTime = 0, this.lifeDuration = i.retina.reduceFactor ? r.getValue(q.duration) * (q.duration.sync ? 1 : Math.random()) / i.retina.reduceFactor * 1e3 : 0, this.lifeTime = 0, this.livesRemaining = g.life.count, this.spawning = this.lifeDelay > 0, this.lifeDuration <= 0 && (this.lifeDuration = -1), this.livesRemaining <= 0 && (this.livesRemaining = -1), this.shadowColor = A.colorToRgb(this.particlesOptions.shadow.color), this.updater = new et(i, this), this.infecter = new qt(i), this.mover = new _t(i, this)
                        }
                        move(t) {
                            this.mover.move(t)
                        }
                        ...
                        calcPosition(t, i) {
                            ...
                            const s = {
                                    ...
                                    y: null !== (o = null == i ? void 0 : i.y) && void 0 !== o ? o : Math.random() * t.canvas.size.height
                                },
                                n = this.particlesOptions.move.outMode;
                            return (P.isInArray(n, u.bounce) || P.isInArray(n, u.bounceHorizontal)) && (s.x > t.canvas.size.width - 2 * this.size.value ? s.x -= this.size.value : s.x < 2 * this.size.value && (s.x += this.size.value)), (P.isInArray(n, u.bounce) || P.isInArray(n, u.bounceVertical)) && (s.y > t.canvas.size.height - 2 * this.size.value ? s.y -= this.size.value : s.y < 2 * this.size.value && (s.y += this.size.value)), s
                        }
                        calculateVelocity() {
                        ...
                        loadImageShape(t, i) {
                            ...
                            if (void 0 !== c.svgData && l.replaceColor && d) {
                                ...
                                h = {
                                    ...
                                    e.revokeObjectURL(s), P.loadImage(l.src).then((t => {
                    ...
                    class Wt {
                        ...
                        isEnabled() {
                            ...
                            const a = o.onHover.mode,
                                r = o.onClick.mode;
                            return P.isInArray(d.repulse, a) || P.isInArray(l.repulse, r) || n
                        }
                        reset() {}
                        interact() {
                            const t = this.container,
                                ...
                                r = o.onClick.mode,
                                h = o.onDiv;
                            e && s && P.isInArray(d.repulse, n) ? this.hoverRepulse() : a && P.isInArray(l.repulse, r) ? this.clickRepulse() : P.divModeExecute(c.repulse, h, ((t, i) => this.singleSelectorRepulse(t, i)))
                        }
                        ...
                        processRepulse(t, i, e, o) {
                            ...
                            for (const e of a) {
                                const {
                                    ...
                                    x: a / c,
                                    y: l / c
                                }, h = 100 * (null !== (s = null == o ? void 0 : o.speed) && void 0 !== s ? s : n.options.interactivity.modes.repulse.speed), u = r.clamp((1 - Math.pow(c / i, 2)) * h, 0, 50);
                    ...
                    class Gt {
                        ...
                        interact() {
                            const t = this.container.options.interactivity.events,
                                ...
                                a = e.mode,
                                r = t.onDiv;
                            o && P.isInArray(d.bubble, s) ? this.hoverBubble() : n && P.isInArray(l.bubble, a) ? this.clickBubble() : P.divModeExecute(c.bubble, r, ((t, i) => this.singleSelectorHover(t, i)))
                        }
                        ...
                        process(t, i, e, o) {
                            ...
                            const a = s.options.interactivity.modes.bubble.duration,
                                ...
                                h = o.type;
                            if (n !== l)
                                if (s.bubble.durationEnd) c && (h === m.size && delete t.bubble.radius, h === m.opacity && delete t.bubble.opacity);
                                else if (i <= r) {
                                if ((null != c ? c : d) !== n) {
                                    const i = d - e * (d - n) / a;
                                    h === m.size && (t.bubble.radius = i), h === m.opacity && (t.bubble.opacity = i)
                                }
                            } else h === m.size && delete t.bubble.radius, h === m.opacity && delete t.bubble.opacity
                        }
                        clickBubble() {
                            var t;
                            const i = this.container,
                        ...
                        hoverBubbleSize(t, i, e) {
                            var o;
                            const s = this.container,
                                n = (null == e ? void 0 : e.size) ? e.size * s.retina.pixelRatio : s.retina.bubbleModeSize;
                            if (void 0 === n) return;
                    ...
                    class Yt {
                        ...
                        resolveCollision(t, i) {
                            switch (t.particlesOptions.collisions.mode) {
                                ...
                                case h.bounce:
                                    ! function(t, i) {
                                        P.circleBounce(P.circleBounceDataFromParticle(t), P.circleBounceDataFromParticle(i))
                                    }(t, i);
                                    break;
                                case h.destroy:
                                    ! function(t, i) {
                    ...
                    class Qt {
                        ...
                        isEnabled() {
                            const t = this.container,
                                ...
                                e = t.interactivity.mouse,
                                o = i.interactivity.events;
                            return e.clicking && e.inside && !!e.position && P.isInArray(l.trail, o.onClick.mode) || e.inside && !!e.position && P.isInArray(d.trail, o.onHover.mode)
                        }
                        reset() {}
                    }
                    class Zt {
                        ...
                        interact() {
                            const t = this.container,
                                ...
                                a = o.onClick.enable,
                                r = o.onClick.mode;
                            e && s && P.isInArray(d.attract, n) ? this.hoverAttract() : a && P.isInArray(l.attract, r) && this.clickAttract()
                        }
                        hoverAttract() {
                            const t = this.container,
                                i = t.interactivity.mouse.position;
                    ...
                    class ii {
                        ...
                        isEnabled() {
                            const t = this.container,
                                ...
                                o = i.interactivity.events,
                                s = o.onDiv;
                            return e.position && o.onHover.enable && P.isInArray(d.bounce, o.onHover.mode) || P.isDivModeEnabled(c.bounce, s)
                        }
                        interact() {
                            const t = this.container,
                                ...
                                s = i.onHover.mode,
                                n = i.onDiv;
                            e && o && P.isInArray(d.bounce, s) ? this.processMouseBounce() : P.divModeExecute(c.bounce, n, ((t, i) => this.singleSelectorBounce(t, i)))
                        }
                        reset() {}
                        processMouseBounce() {
                            const t = this.container,
                        ...
                        processBounce(t, i, e) {
                            ...
                            for (const s of o) e instanceof D ? P.circleBounce(P.circleBounceDataFromParticle(s), {
                                position: t,
                                radius: i,
                                velocity: {
                                    horizontal: 0,
                    ...
                    class ei {
                        constructor(t) {
                            this.container = t, this.externalInteractors = [new ii(t), new Gt(t), new $t(t), new Nt(t), new ti(t), new Zt(t), new Wt(t), new Qt(t)], this.particleInteractors = [new Xt(t), new Kt(t), new Yt(t), new Jt(t), new jt(t)]
                        }
                        init() {}
                        externalInteract(t) {
                    ...
                    class oi {
                        constructor(t) {
                            ...
                            this.linksColors = new Map, this.quadTree = new W(new I(-i.width / 4, -i.height / 4, 3 * i.width / 2, 3 * i.height / 2), 4)
                        }
                        get count() {
                        ...
                        update(t) {
                            ...
                            for (const e of this.array) e.move(t), e.destroyed ? i.push(e) : this.quadTree.insert(new N(e.getPosition(), e));
                        ...
                        draw(t) {
                            ...
                            this.quadTree = new W(new I(-e.width / 4, -e.height / 4, 3 * e.width / 2, 3 * e.height / 2), 4), this.update(t);
                    ...
                    class si {
                        ...
                        init() {
                            const t = this.container,
                                i = t.options;
                            i.detectRetina ? this.pixelRatio = P.isSsr() ? 1 : window.devicePixelRatio : this.pixelRatio = 1;
                            const e = this.container.options.motion;
                            if (e && (e.disable || e.reduce.value))
                                if (P.isSsr() || "undefined" == typeof matchMedia || !matchMedia) this.reduceFactor = 1;
                                else {
                    ...
                    class Mi {
                        ...
                        load(t) {
                            void 0 !== t && (void 0 !== t.delay && (this.delay = t.delay), void 0 !== t.quantity && (this.quantity = t.quantity), void 0 !== t.particles && (this.particles = P.deepExtend({}, t.particles)))
                        }
                    }
                    class Pi {
                        constructor() {
                    ...
                    class Ei {
                        constructor() {
                            this.attract = new Pi, this.bounce = new Ti, this.bubble = new vi, this.connect = new yi, this.grab = new mi, this.light = new Ai, this.push = new bi, this.remove = new gi, this.repulse = new ki, this.slow = new zi, this.trail = new Mi
                        }
                        load(t) {
                    ...
                    class qi {
                        ...
                        load(t) {
                            void 0 !== t && (void 0 !== t.name && (this.name = t.name), this.default.load(t.default), void 0 !== t.options && (this.options = P.deepExtend({}, t.options)))
                        }
                    }
                    class _i {
                        constructor() {
                    ...
                    class Wi {
                        load(t) {
                            ...
                            }), void 0 !== t.options && (this.options = P.deepExtend({}, t.options)))
                        }
                    }
                    class Ui {
                        constructor() {
                            this.autoPlay = !0, this.background = new Li, this.backgroundMask = new Ii, this.backgroundMode = new _i, this.detectRetina = !0, this.fpsLimit = 30, this.infection = new Fi, this.interactivity = new Oi, this.manualParticles = [], this.motion = new Ni, this.particles = new Vt, this.pauseOnBlur = !0, this.pauseOnOutsideViewport = !1, this.themes = []
                        }
                        get fps_limit() {
                    ...
                    class $i {
                        constructor(t, i, ...e) {
                            this.id = t, this.sourceOptions = i, this.firstStart = !0, this.started = !1, this.destroyed = !1, this.paused = !0, this.lastFrameTime = 0, this.pageHidden = !1, this.retina = new si(this), this.canvas = new tt(this), this.particles = new oi(this), this.drawer = new ni(this), this.noise = {
                                ...
                                particles: []
                            }, this.plugins = new Map, this.drawers = new Map, this.density = 1, this.options = new Ui;
                        ...
                        pause() {
                            if (void 0 !== this.drawAnimationFrame && (P.cancelAnimation(this.drawAnimationFrame), delete this.drawAnimationFrame), !this.paused) {
                                for (const [, t] of this.plugins) t.pause && t.pause();
                                this.pageHidden || (this.paused = !0)
                            }
                        }
                        draw() {
                            this.drawAnimationFrame = P.animate((t => this.drawer.nextFrame(t)))
                        }
                        getAnimationStatus() {
                            return !this.paused
                        }
                        ...
                        static set(t, i, e, o) {
                            return ji(this, void 0, void 0, (function*() {
                                ...
                                if ("canvas" === i.tagName.toLowerCase()) r = i, l = !1;
                                    ...
                                    t.length ? (r = t[0], r.className || (r.className = S.canvasClass), l = !1) : (l = !0, r = document.createElement("canvas"), r.className = S.canvasClass, r.style.width = "100%", r.style.height = "100%", i.appendChild(r))
                                }
                                const c = new $i(t, s);
                    ...
                    class Ki {
                        ...
                        resize() {
                            ...
                            this.position = t && P.isPointInside(t, this.container.canvas.size) ? t : this.calcPosition()
                        }
                        draw(t) {
                    ...
                    class ie {
                        constructor() {
                            this.color = new ot, this.color.value = "#000000", this.draggable = !1, this.opacity = 1, this.destroy = !0, this.orbits = !1, this.size = new te
                        }
                        load(t) {
                    ...
                    class ee {
                        ...
                        init(t) {
                            ...
                            t.absorbers && (t.absorbers instanceof Array ? this.absorbers = t.absorbers.map((t => {
                                const i = new ie;
                                return i.load(t), i
                            })) : (this.absorbers instanceof Array && (this.absorbers = new ie), this.absorbers.load(t.absorbers)));
                            ...
                            if (o && (o instanceof Array ? this.interactivityAbsorbers = o.map((t => {
                                    const i = new ie;
                                    return i.load(t), i
                                })) : (this.interactivityAbsorbers instanceof Array && (this.interactivityAbsorbers = new ie), this.interactivityAbsorbers.load(o))), this.absorbers instanceof Array)
                        ...
                        handleClickMode(t) {
                            ...
                            if (t === Qi.absorber) {
                                let t;
                                o instanceof Array ? o.length > 0 && (t = P.itemFromArray(o)) : t = o;
                                const s = null != t ? t : e instanceof Array ? P.itemFromArray(e) : e,
                    ...
                    const oe = new class {
                        ...
                        needsPlugin(t) {
                            ...
                            const s = t.absorbers;
                            let n = !1;
                            return s instanceof Array ? s.length && (n = !0) : (void 0 !== s || (null === (o = null === (e = null === (i = t.interactivity) || void 0 === i ? void 0 : i.events) || void 0 === e ? void 0 : e.onClick) || void 0 === o ? void 0 : o.mode) && P.isInArray(Qi.absorber, t.interactivity.events.onClick.mode)) && (n = !0), n
                        }
                        loadOptions(t, i) {
                            var e, o;
                            ...
                            if (null == i ? void 0 : i.absorbers)
                                if ((null == i ? void 0 : i.absorbers) instanceof Array) s.absorbers = null == i ? void 0 : i.absorbers.map((t => {
                                    ...
                                    let t = s.absorbers;
                                    void 0 === (null == t ? void 0 : t.load) && (s.absorbers = t = new ie), t.load(null == i ? void 0 : i.absorbers)
                                }
                            ...
                            if (n)
                                if (n instanceof Array) s.interactivity.modes.absorbers = n.map((t => {
                                    ...
                                    void 0 === (null == t ? void 0 : t.load) && (s.interactivity.modes.absorbers = t = new ie), t.load(n)
                                }
                        }
                    };
                    class se {
                    ...
                    class re {
                        constructor(t, i, e, o) {
                            var s, n, a;
                            this.emitters = t, this.container = i, this.initialPosition = o, this.emitterOptions = P.deepExtend({}, e), this.position = null !== (s = this.initialPosition) && void 0 !== s ? s : this.calcPosition();
                        ...
                        emit() {
                            ...
                            for (let o = 0; o < this.emitterOptions.rate.quantity; o++) t.particles.addParticle(ae(i, e), this.particlesOptions)
                        }
                    }
                    class le {
                        constructor() {
                    ...
                    class de {
                        constructor() {
                            this.direction = n.none, this.life = new ce, this.rate = new le
                        }
                        load(t) {
                            void 0 !== t && (void 0 !== t.size && (void 0 === this.size && (this.size = new se), this.size.load(t.size)), void 0 !== t.direction && (this.direction = t.direction), this.life.load(t.life), void 0 !== t.particles && (this.particles = P.deepExtend({}, t.particles)), this.rate.load(t.rate), void 0 !== t.position && (this.position = {
                                x: t.position.x,
                                y: t.position.y
                            }))
                        }
                    ...
                    class ue {
                        ...
                        init(t) {
                            ...
                            t.emitters && (t.emitters instanceof Array ? this.emitters = t.emitters.map((t => {
                                const i = new de;
                                return i.load(t), i
                            })) : (this.emitters instanceof Array && (this.emitters = new de), this.emitters.load(t.emitters)));
                            ...
                            if (o && (o instanceof Array ? this.interactivityEmitters = o.map((t => {
                                    const i = new de;
                                    return i.load(t), i
                                })) : (this.interactivityEmitters instanceof Array && (this.interactivityEmitters = new de), this.interactivityEmitters.load(o))), this.emitters instanceof Array)
                    ...
                    const ve = new class {
                        ...
                        needsPlugin(t) {
                            ...
                            const s = t.emitters;
                            let n = !1;
                            return s instanceof Array ? s.length && (n = !0) : (void 0 !== s || (null === (o = null === (e = null === (i = t.interactivity) || void 0 === i ? void 0 : i.events) || void 0 === e ? void 0 : e.onClick) || void 0 === o ? void 0 : o.mode) && P.isInArray(he.emitter, t.interactivity.events.onClick.mode)) && (n = !0), n
                        }
                        loadOptions(t, i) {
                            var e, o;
                            if (!this.needsPlugin(t) && !this.needsPlugin(i)) return;
                            ...
                            if (null == i ? void 0 : i.emitters)
                                if ((null == i ? void 0 : i.emitters) instanceof Array) s.emitters = null == i ? void 0 : i.emitters.map((t => {
                                    ...
                                    let t = s.emitters;
                                    void 0 === (null == t ? void 0 : t.load) && (s.emitters = t = new de), t.load(null == i ? void 0 : i.emitters)
                                }
                            ...
                            if (n)
                                if (n instanceof Array) s.interactivity.modes.emitters = n.map((t => {
                                    ...
                                    void 0 === (null == t ? void 0 : t.load) && (s.interactivity.modes.emitters = t = new de), t.load(n)
                                }
                        }
                    };
                    var pe, ye, fe;
                    ...
                    class ke {
                        constructor() {
                            this.draw = new ge, this.enable = !1, this.inline = new we, this.move = new be, this.scale = 1, this.type = fe.none
                        }
                    ...
                    class Re {
                        constructor(t) {
                            this.container = t, this.dimension = {
                                height: 0,
                                width: 0
                            }, this.path2DSupported = !!window.Path2D, this.options = new ke, this.polygonMaskMoveRadius = this.options.move.radius * t.retina.pixelRatio
                        }
                        initAsync(t) {
                        ...
                        resize() {
                            const t = this.container,
                                i = this.options;
                            i.enable && i.type !== fe.none && (this.redrawTimeout && clearTimeout(this.redrawTimeout), this.redrawTimeout = window.setTimeout((() => ze(this, void 0, void 0, (function*() {
                        ...
                        particlesInitialization() {
                            ...
                            return !(!t.enable || t.type !== fe.inline || t.inline.arrangement !== pe.onePerPoint && t.inline.arrangement !== pe.perPoint) && (this.drawPoints(), !0)
                        }
                        particlePosition(t) {
                            var i, e;
                            if (this.options.enable && (null !== (e = null === (i = this.raw) || void 0 === i ? void 0 : i.length) && void 0 !== e ? e : 0) > 0) return P.deepExtend({}, t || this.randomPoint())
                        }
                        particleBounce(t) {
                            const i = this.options;
                        ...
                        draw(t) {
                            ...
                            for (const i of this.paths) {
                                ...
                                t && (n && e && this.offset ? Se(t, e, o.stroke, this.offset) : s && Pe(t, s, o.stroke))
                            }
                        }
                    ...
                    const Ce = new class {
                        ...
                        needsPlugin(t) {
                            var i, e, o;
                            return null !== (e = null === (i = null == t ? void 0 : t.polygon) || void 0 === i ? void 0 : i.enable) && void 0 !== e ? e : void 0 !== (null === (o = null == t ? void 0 : t.polygon) || void 0 === o ? void 0 : o.type) && t.polygon.type !== fe.none
                        }
                        loadOptions(t, i) {
                            if (!this.needsPlugin(i)) return;
                            const e = t;
                            let o = e.polygon;
                            void 0 === (null == o ? void 0 : o.load) && (e.polygon = o = new ke), o.load(null == i ? void 0 : i.polygon)
                        }
                    };
                    const Ae = new class extends class {
                        ...
                        constructor() {
                            super(), this.addPlugin(oe), this.addPlugin(ve), this.addPlugin(Ce)
                        }
                    };
                    Ae.init();
                    const {
